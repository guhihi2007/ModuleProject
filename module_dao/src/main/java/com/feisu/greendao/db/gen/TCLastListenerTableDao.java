...
public class TCLastListenerTableDao extends AbstractDao<TCLastListenerTable, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Postion = new Property(10, int.class, "postion", false, "POSTION");
        public final static Property PageNo = new Property(11, int.class, "pageNo", false, "PAGE_NO");
        public final static Property ProgramIds = new Property(12, String.class, "programIds", false, "PROGRAM_IDS");
        public final static Property Remark1 = new Property(13, String.class, "remark1", false, "REMARK1");
        public final static Property Remark2 = new Property(14, String.class, "remark2", false, "REMARK2");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tc_album_last_one\" (" + //
                ...
                "\"POSTION\" INTEGER NOT NULL ," + // 10: postion
                "\"PAGE_NO\" INTEGER NOT NULL ," + // 11: pageNo
                "\"PROGRAM_IDS\" TEXT," + // 12: programIds
                "\"REMARK1\" TEXT," + // 13: remark1
                "\"REMARK2\" TEXT);"); // 14: remark2
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TCLastListenerTable entity) {
        ...
        stmt.bindLong(11, entity.getPostion());
        stmt.bindLong(12, entity.getPageNo());
 
        String programIds = entity.getProgramIds();
        if (programIds != null) {
            stmt.bindString(13, programIds);
        }
 
        String remark1 = entity.getRemark1();
        if (remark1 != null) {
            stmt.bindString(14, remark1);
        }
 
        String remark2 = entity.getRemark2();
        if (remark2 != null) {
            stmt.bindString(15, remark2);
        }
    }
    ...
    public TCLastListenerTable readEntity(Cursor cursor, int offset) {
        TCLastListenerTable entity = new TCLastListenerTable( //
            ...
            cursor.getInt(offset + 10), // postion
            cursor.getInt(offset + 11), // pageNo
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), // programIds
            cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), // remark1
            cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14) // remark2
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TCLastListenerTable entity, int offset) {
        ...
        entity.setPostion(cursor.getInt(offset + 10));
        entity.setPageNo(cursor.getInt(offset + 11));
        entity.setProgramIds(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        entity.setRemark1(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
        entity.setRemark2(cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14));
     }
